...
- **Anti-gaming detection** is built into the engine, and **~60–70 % of patches** are applied deterministically (rule-based, no LLM) with cross-session episodic memory.
