...
description: >
  ...
  through one or more Schliff improvement cycles. Summarizes baseline
...
1. Read `schliff-results.jsonl` from the skill directory.
...
5. Save the report as `schliff-report.md` in the skill directory.
